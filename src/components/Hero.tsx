...
const Hero = () => {
  return (
    <div
      className="relative overflow-clip bg-[linear-gradient(to_bottom,#000,#2B1942_35%,#BF5C55_60%,#DBAF6E_80%)]"
      // className="py-24 relative overflow-clip bg-[linear-gradient(to_bottom,#000,#2B1942_35%,#BF5C55_60%,#DBAF6E_80%)]"
    >
      <div
